...
public class OutputDirectoryPropertyAnnotationHandler<A extends Annotation> implements PropertyAnnotationHandler {
    ...
    public OutputDirectoryPropertyAnnotationHandler(Class<A> annotationType, Transformer<Iterable<File>, Object> valueTransformer, FileAnnotationExtractor<A> annotationExtractor) {
